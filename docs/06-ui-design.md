...
- The rail is 240 px wide (180 px until D-249 widened it for the filters). It holds the sections, the Servers filters under them while that page is open (§4), and the update item at its foot (D-216). Every section label and icon is in the accent; the open one has the raised surface, the accent bar and a heavier weight, and the update item an accent tint (D-250).
