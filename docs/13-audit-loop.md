...
- ~~From D-279: (a) check for updates again while the launcher stays open; (b) show the window again when Windows refuses the downloaded setup; (c) ask before "Install and restart" while DayZ is running or a mod download is in progress~~ approved 2026-09-26 and applied in v0.1.65 (D-280).
