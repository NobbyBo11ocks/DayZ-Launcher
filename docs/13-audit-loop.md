...
| 7 | **Front-end state and flows**: the servers store, filters, sort and counts, dialogs, event listeners — non-visual bugs only | IN PROGRESS since 2026-09-26T11:38Z | |
