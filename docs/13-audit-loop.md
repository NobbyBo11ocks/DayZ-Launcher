...
| 6 | **Installer and updater**: NSIS template and `hooks.nsh` (D-262 icons included), update and uninstall modes, the updater manifest, the release workflow | IN PROGRESS since 2026-09-26T10:30Z (restarted from the beginning) | |
