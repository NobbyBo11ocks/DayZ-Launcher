...
|---|---|---|---|
| Installer size (NSIS, downloadBootstrapper) | < 15 MB | M0 1.32 MB; M4 2.26 MB; M7 3.23 MB (exe 8.54 MB with SQLite, Steamworks and the updater's TLS stack); v0.1.3+flags 3.83 MB (exe 10.5 MB: +1.79 MB GeoIP table, +145 KB flag sprite, D-073); v0.1.6 4.43 MB; **v0.1.31 4.64 MB** and **v0.1.35 4.75 MB** (4 747 050 B), 32 % of budget (4 433 490 B, exe 12.4 MB: + notification plugin and reqwest/rustls for the DZSA fallback, D-086/D-089; LAN and Friends tabs, D-092/D-094); v0.1.8 4.52 MB (4 524 390 B, exe 12.7 MB: + opener and window-state plugins, news module, D-098/D-099); v0.1.12 4.68 MB (4 675 803 B, exe 13.1 MB: + `image` jpeg/png for the news thumbnails, D-111); v0.1.19 4.69 MB (4 687 251 B, exe 13.2 MB); **v0.1.23 4.73 MB** (4 731 638 B, exe 13.2 MB: the Logs page and the HTTP caps in, the Diagnostics inventory tables and `perf.rs` out), D-179 | file size |
